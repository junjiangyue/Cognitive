...
public class Exercise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         */
        adapter = new ArticleAdapter(Exercise.this, data);
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int position,
                 ...
                 * 创建一个意图
                 */
                Intent intent = new Intent(Exercise.this,ArticleInfo.class);
                ...
                Exercise.this.startActivity(intent);//启动Activity
    ...
    public void getData(String url){
        ...
        final RequestQueue mQueue = Volley.newRequestQueue(Exercise.this);

...
public class VerifyLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DestroyActivityUtil.addActivity(VerifyLogin.this);
        //获取输入框数据
        ...
        get_veri_code.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {new Thread(postVeri).start();}
                    ...
                    Toast.makeText(VerifyLogin.this,"请填写手机号！", Toast.LENGTH_LONG).show();
                }
            }
        });
        ...
        Login.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(VerifyLogin.this,LoginActivity.class);
                ...
                case R.id.btn_login:
                    if(!et_data_veri.getText().toString().equals("") &&et_data_veri.getText().toString().equals(verficationCode)) {
                        ...
                        new Thread(postRun).start();
                            ...
                            Toast.makeText(VerifyLogin.this,"验证码错误", Toast.LENGTH_LONG).show();
                        }
                    break;
                case R.id.btn_signup:
                    Intent intent = new Intent(VerifyLogin.this,RegisterActivity.class);
                    startActivity(intent);
                    break;
                default:break;
            }
            ...
            if (urlConn.getResponseCode() == 200) {
                ...
                try {
                    ...
                    switch (code){
                        ...
                        default:
                            Looper.prepare();
                            Toast.makeText(VerifyLogin.this,"手机号错误，请重新登录", Toast.LENGTH_LONG).show();
                            Looper.loop();
                            break;
                    }
                ...
                Toast.makeText(VerifyLogin.this,"手机号或密码错误，请重新登录", Toast.LENGTH_LONG).show();
                Looper.loop();
            }
            // 关闭连接
            urlConn.disconnect();

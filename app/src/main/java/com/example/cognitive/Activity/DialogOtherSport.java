...
/*public class DialogOtherSport extends AppCompatActivity {
    ...
    private FancyButton btnOtherSportFinish;
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //完成一项打卡
        btnOtherSportFinish=findViewById(R.id.btn_other_sport_finish);
        btnOtherSportFinish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                editor1.commit();
                Intent intent = new Intent(DialogOtherSport.this, FinishHealthyTask.class);
...
public class DialogOtherSport extends Dialog {
    private SharedPreferences spFinishTask;
    private SharedPreferences spWeekReport;
    private LinearLayout llSportInfo;
    private FancyButton btnOtherSportCancel;
    ...
    DialogOtherSport.DataBackListener listener;
    public DialogOtherSport(Context context, final DialogOtherSport.DataBackListener listener){
        super(context);
        //用传递过来的监听器来初始化
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*llSportInfo.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getContext(), SportInfo.class);
                startActivity(intent);
            }
        });*/
        btnOtherSportCancel.setOnClickListener(new View.OnClickListener() {

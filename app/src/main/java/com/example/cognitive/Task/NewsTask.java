//package com.example.cognitive.Task;
//import android.os.AsyncTask;
//import java.io.IOException;
//import java.util.ArrayList;
//import com.example.cognitive.Bean.Articles;
//import com.example.cognitive.Utils.JSONUtils;
//import okhttp3.OkHttpClient;
//import okhttp3.Request;
//import okhttp3.Response;
//
//public class NewsTask extends AsyncTask<String,Void,ArrayList<Articles>>{
...
//        //************************访问网络获取数据，得到列表项的数据*****************
//        ArrayList<Articles> result=null;  //创建arraylist ,接收数据
//
...
//        void getResults(ArrayList<Articles> result);
//    }
//
//}
